...
const sortOptions = [
  ...
  { value: 'title', label: 'نام محصول', sortBy: 'title', sortOrder: 'ASC' },
  { value: 'price_asc', label: 'ارزان‌ترین', sortBy: 'price', sortOrder: 'ASC' },
  { value: 'price_desc', label: 'گران‌ترین', sortBy: 'price', sortOrder: 'DESC' },
]
